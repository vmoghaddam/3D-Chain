'use strict';
app.controller('signup2Controller', ['$scope', '$location', '$routeParams', '$rootScope', 'pageService', 'authService', 'userService', '$route', function ($scope, $location, $routeParams, $rootScope, pageService, authService, userService, $route) {
    ...
    $scope.passwordValidationRules = {
        validationGroup: 'signup2service',
        validationRules: [{
